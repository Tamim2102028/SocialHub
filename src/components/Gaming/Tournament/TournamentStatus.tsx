...
const TournamentStatus: React.FC<TournamentStatusProps> = ({
  ...
  return (
    <div
      className={`${getStatusColor()} overflow-hidden rounded-lg border text-white shadow`}
    >
      <div className="p-6">
        ...
        {/* Tournament Schedule */}
        {status === "registration" && (
          <div className="mt-6 grid grid-cols-6 gap-2 rounded border border-white/20 bg-white/10 p-3">
